...
[0, 0, 1, 1, 2, 4, 7, 13, 24, ...]
Well, you may have guessed it by now, but to be clear: you need to create a fibonacci function that given a signature array/list, returns the 
...
If you enjoyed this kata more advanced and generalized version of it can be found in the Xbona */
...
/* 26. Write Number in Expanded Form
...
function expandedForm(num) {
  return num
    ...
    .filter((term) => parseInt(term) !== 0) // Filter out zero terms
    .join(" + ");
}
